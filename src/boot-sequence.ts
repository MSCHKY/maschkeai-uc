...
// Dynamic boot claims — rotated per page load (vDNA-aligned)
const BOOT_CLAIMS = [
    ' maschke.ai · Systeme, die echte Arbeit mitdenken.',
    ' maschke.ai · Software lernt den Menschen.',
    ' maschke.ai · Kreativ-Agentur für Künstliche Intelligenz',
];

function pickBootClaim(): string {
    return BOOT_CLAIMS[Math.floor(Math.random() * BOOT_CLAIMS.length)];
}

export function getBootSequence(): BootLine[] {
    return [
        ...
        { text: '', cls: '', delay: 200 },
        { text: 'PROGRESS_BAR', cls: 'progress-bar', delay: 0 },
        { text: '', cls: '', delay: 400 },
        { text: 'ASCII_LOGO', cls: 'line-logo', delay: 0 },
        { text: '', cls: '', delay: 300 },
        { text: pickBootClaim(), cls: 'line-dim', delay: 60 },
        { text: '', cls: '', delay: 300 },
